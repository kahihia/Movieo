...
from movieo_project import views
...
urlpatterns = patterns('',
                       ...
                       url(r'^rango/like_category/$', views.like_category, name='like_category'),
                       url(r'^rango/suggest_category/$', views.suggest_category, name='suggest_category'),
                       url(r'^rango/auto_add_page/$', views.auto_add_page, name='auto_add_page'),
                       )
