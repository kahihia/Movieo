...
class MovieSerializer(serializers.ModelSerializer):
    class Meta:
        model = Movie
        fields = ('id', 'created', 'name', 'tagline', 'language', 'country', 'runtime', 'no_of_reviews', 'written_by', 'directed_by', 'date_of_release', 'description', 'genre', 'rating', 'budget', 'box_office', 'poster', 'cover')
...
class MovieReviewsSerializer(serializers.ModelSerializer):
        class Meta:
            model = MovieReviews
            fields = ('id', 'created',  'movie_id', 'user_id', 'description', 'rating', 'positivity')
